...
for f in os.listdir('logpure/'):
    ff = open('logpure/' + f)
    for line in ff:
        processLinepure(line)
    ff.close()
...
print(txtStat.appboxTotalTypeSize(globalData, 'self'))
print(txtStat.appboxTotalTypeSize(globalData, 'indie'))
print(txtStat.appboxTotalTypeSize(globalData, 'double'))
print(txtStat.appboxTotalTypeSize(globalData, 'none'))
